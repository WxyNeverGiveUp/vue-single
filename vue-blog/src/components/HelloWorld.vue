<template>  
    <div class="Login">
        ...
        <form @submit.prevent="submit_req" method="post" id="login_registered" style="display:none">
            <input type="text" name="" value="" placeholder="用户名" v-model="regData.username"/><label for=""></label>
